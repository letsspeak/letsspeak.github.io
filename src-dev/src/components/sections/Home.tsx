...
const Home: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-gray-50 flex items-center -mt-20 pt-24">
              ...
              <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  <h1 className="text-4xl tracking-normal font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    ...
                    <span className="block xl:inline xl:ml-3" style={{
                      background: 'linear-gradient(90deg, #2563eb 0%, #1d4ed8 30%, #7c3aed 100%)',
